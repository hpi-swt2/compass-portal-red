...
RSpec.describe "options/index", type: :view do
  ...
  it "does not render a 'log out' and 'Edit personal Information' button when signed out" do
...
=begin
  ...
  it "renders a 'Contribute - Solve Data problems' and 'Report a problem' button when signed in as non admin user" do
    current_user = User.create!(
        username: "Peter Maffay",
        isAdmin: false,
        password: "imakeyousexy",
  ...
  it "renders a 'Show data tables' and 'Data management' button when signed in as admin user" do
    current_user = User.create!(
        username: "Peter Maffay",
        isAdmin: true,
        password: "imakeyousexy",
